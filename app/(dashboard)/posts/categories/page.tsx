    ...
    <div className="page animate-fade-up max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-medium text-violet-400">Content organization</p>
            <h1 className="mt-1 text-2xl font-bold tracking-tight text-white">Categories</h1>
            <p className="mt-1 text-xs text-white/50">Organize posts with workspace-specific content categories.</p>
          </div>
        </div>
      </div>
