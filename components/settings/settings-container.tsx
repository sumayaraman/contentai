...
export function SettingsContainer({
  ...
  return (
    <div className="space-y-8">
      {/* Sleek Segmented Tab Navigation Bar with ample breathing room */}
      <div className="inline-flex items-center gap-1.5 p-1.5 rounded-2xl bg-white/[0.03] border border-white/[0.08] max-w-full overflow-x-auto shadow-sm">
        {TABS.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-medium transition-all duration-150 whitespace-nowrap cursor-pointer ${
                isActive
