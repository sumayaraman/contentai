        ...
        <section className="rounded-2xl border border-white/[0.08] bg-[#0e0e1a]/85 backdrop-blur-xl shadow-xl shadow-black/25 overflow-hidden">
          <div className="flex items-center gap-3 px-6 py-4.5 border-b border-white/[0.06] bg-white/[0.015]">
            ...
            <div>
              ...
              <p className="text-xs text-white/40 mt-0.5">Customize your brand workspace identifier</p>
            </div>
          </div>

          <div className="p-6 sm:p-7 space-y-4">
            <div className="max-w-md">
              <label htmlFor="workspace-name-input" className="block text-xs font-semibold text-white/70 mb-1.5">
                Workspace Name
              </label>
              <input
                ...
                className="h-10 w-full rounded-xl border border-white/10 bg-[#141426] px-3.5 text-xs sm:text-sm text-white outline-none transition focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 disabled:opacity-40"
              />
            </div>
          </div>
        ...
        <section className="rounded-2xl border border-white/[0.08] bg-[#0e0e1a]/85 backdrop-blur-xl shadow-xl shadow-black/25 overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4.5 border-b border-white/[0.06] bg-white/[0.015]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-sm font-semibold text-white">Team Members &amp; Permissions</h2>
                <p className="text-xs text-white/40 mt-0.5">Control role assignments and collaborator privileges</p>
              </div>
            </div>
                ...
                {members.map((member) => (
                  <tr key={member.membership_id} className="hover:bg-white/[0.02] transition">
                    <td className="px-6 py-3.5">
                      <div className="flex items-center gap-3">
                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-violet-500/15 text-violet-300 border border-violet-500/25 text-xs font-bold">
                    ...
                    <td className="px-6 py-3.5">
                      {member.role === "OWNER" ? (
                        ...
                        <select
                          ...
                          className="h-8 rounded-lg border border-white/10 bg-[#141426] px-2.5 text-xs font-medium text-white outline-none cursor-pointer focus:border-violet-500"
                        >
                    ...
                    <td className="px-6 py-3.5 text-xs text-white/40">
                    ...
                    <td className="px-6 py-3.5 text-right">
                      {role === "OWNER" && member.role !== "OWNER" && (
                        <button
                          ...
                          disabled={busy === member.membership_id}
                          className="inline-flex h-7 items-center gap-1 rounded-lg border border-rose-500/20 bg-rose-500/10 px-2.5 text-xs font-medium text-rose-300 hover:bg-rose-500/20 transition disabled:opacity-50 cursor-pointer"
                        >
        ...
        <section className="rounded-2xl border border-white/[0.08] bg-[#0e0e1a]/85 backdrop-blur-xl shadow-xl shadow-black/25 overflow-hidden">
          <div className="flex items-center gap-3 px-6 py-4.5 border-b border-white/[0.06] bg-white/[0.015]">
            ...
            <div>
              ...
              <p className="text-xs text-white/40 mt-0.5">Select the default intelligence engine used for drafting campaigns and posts</p>
            </div>
          </div>

          <div className="p-6 sm:p-7 space-y-4">
            <div className="max-w-md">
              <label htmlFor="ai-provider-select" className="block text-xs font-semibold text-white/70 mb-1.5">
              ...
              <select
                ...
                className="h-10 w-full rounded-xl border border-white/10 bg-[#141426] px-3.5 text-xs sm:text-sm text-white outline-none transition focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 disabled:opacity-40 cursor-pointer"
              >
